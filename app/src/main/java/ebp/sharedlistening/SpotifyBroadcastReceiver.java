...
public class SpotifyBroadcastReceiver extends BroadcastReceiver {
    ...
    private SpotifyAppReceivedSingleton receivedSingleton = SpotifyAppReceivedSingleton.getInstance();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BroadcastTypes.METADATA_CHANGED)) {
            ...
            // Do something with extracted information
            receivedSingleton.updatePlaybackState(new SpotifyPlaybackState(playing, positionInMs));
